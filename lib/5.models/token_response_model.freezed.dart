...
/// @nodoc
@JsonSerializable()
class _$TokenResponseModelImpl
    with DiagnosticableTreeMixin
    implements _TokenResponseModel {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'TokenResponseModel'))
...
abstract class _TokenResponseModel implements TokenResponseModel {
  const factory _TokenResponseModel(
      ...
      required final String refreshToken}) = _$TokenResponseModelImpl;
